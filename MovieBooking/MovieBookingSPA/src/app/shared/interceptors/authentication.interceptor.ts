...
export class AuthenticationInterceptor implements HttpInterceptor {
  private readonly whitelistUrls: string[] = ['/api/v1/CustomerAuthentication/LoginCustomer',
                                              '/api/v1/AdminAuthentication/LoginAdmin',
                                              '/api/v1/CustomerAuthentication/Refresh',
                                              '/api/v1/AdminAuthentication/Refresh'];
